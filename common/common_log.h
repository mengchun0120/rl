#ifndef INCLUDED_COMMON_LOG_H
#define INCLUDED_COMMON_LOG_H
...
#define LOGGER (common::Logger::k_logger)
...
#define LOG_START(level) \
    ...
    { \
        LOGGER->logTime() << ' ' << __FILE__ << ':' << __LINE__ << ' ' \
                          << common::Logger::k_levelStr[(level)] \
                          << ' '
...
#define LOG_DEBUG LOG_START(common::Logger::LEVEL_DEBUG)
#define LOG_INFO LOG_START(common::Logger::LEVEL_INFO)
#define LOG_WARN LOG_START(common::Logger::LEVEL_WARN)
#define LOG_ERROR LOG_START(common::Logger::LEVEL_ERROR)

#endif // INCLUDED_COMMON_LOG_H
